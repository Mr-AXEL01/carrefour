...
<section class="py-20 bg-black">
   ...
   <div class="bg-[white] rounded-b-md">
    <div class="p-9">
     <div class="space-y-6 text-slate-700">
      <img class="object-cover h-12" src="<?= URLROOT . '/public/images/carrefour2.png'?>"
 ...
 <button class="button-invoice bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center">
...
<script src="<?php echo URLROOT; ?>/js/invoice.js"></script>
