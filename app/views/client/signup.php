...
<body>
    <div
        class="min-w-screen min-h-screen bg-[url(<?php echo URLROOT . '/public/images/home.png'; ?>)] bg-blur-xl bg-cover bg-center bg-no-repeat flex items-center justify-center px-5 py-5">
                ...
                <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                    ...
                    <form method="POST" action="" id="form" enctype="multipart/form-data">
                        <div>
                            ...
                            <div class="flex -mx-3">
                                <div class="w-1/2 px-3 mb-5">
                                    <label for="" class="text-xs font-semibold px-1">Adress</label>
                                    <div class="flex">
                                        <div
                                            class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                            <i class="mdi mdi-account-outline text-gray-400 text-lg"></i>
                                ...
                                <div class="w-1/2 px-3 mb-5">
                                    <label for="" class="text-xs font-semibold px-1">Number</label>
                                    <div class="flex">
                                        <div
                                            class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                            <i class="mdi mdi-account-outline text-gray-400 text-lg"></i>
